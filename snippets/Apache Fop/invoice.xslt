				...
				<fo:table-body>
				  <fo:table-row>
					<fo:table-cell text-align="left">
					  <fo:block>
					  <fo:inline color="#2f5496"> PrimeSoft Polska Sp. z o.o.</fo:inline>                   
					  </fo:block>
					</fo:table-cell>
				  </fo:table-row>
				 <fo:table-row>
					<fo:table-cell text-align="left">
					  <fo:block>
						ul. Perkuna 25, 61-615 Poznań tel/fax 061/833-17-72 www.primesoft.pl                
					  </fo:block>
					</fo:table-cell>
				  </fo:table-row>	
				</fo:table-body>
				...
				<fo:table-body>
				  <fo:table-row>
					...
					<fo:table-cell text-align="right">
					  <fo:block>
						<fo:external-graphic src="https://github.com/primesoft-polska/arthurdoc-examples/raw/master/images/arturdoc_logo.png?raw=true" height="20mm" content-height="scale-to-fit"/>
					  </fo:block>
					</fo:table-cell>
				  </fo:table-row>
				</fo:table-body>
			  ...
			  <fo:table>
				...
				<fo:table-body>
				  <fo:table-row height="5mm">
					<fo:table-cell padding-top="1mm" padding-left="2mm"  text-align="left" font-size="10pt" background-color="#2f5496" color="#ffffff">
					  <fo:block>
						INVOICE NO. <xsl:value-of select="Invoice_number"/>
					  </fo:block>
					</fo:table-cell>
					<fo:table-cell padding-top="1mm" padding-right="2mm" text-align="right" font-size="10pt" background-color="#2f5496" color="#ffffff">
					  <fo:block>
			  ...
			  <fo:table>
				...
				<fo:table-body>
				  <fo:table-row>
					<fo:table-cell>
					  <fo:block text-align="left">
						<fo:inline color="#2f5496">BILL TO</fo:inline> 
					  </fo:block>
					</fo:table-cell>	
					<fo:table-cell>				
					  <fo:block text-align="left">
						<fo:inline color="#2f5496">SHIP TO</fo:inline> 
					  </fo:block>
					</fo:table-cell>	
					<fo:table-cell>					  
					  <fo:block text-align="left">
						<fo:inline color="#2f5496">INSTRUCTIONS</fo:inline>
					  </fo:block>				  
					</fo:table-cell>
				  </fo:table-row>
				  <fo:table-row>
				...
				<fo:table-header font-weight="bold">
				  <fo:table-row border-bottom="1px solid #eee">
					<fo:table-cell text-align="left" padding-bottom="2px">
					  <fo:block><fo:inline color="#2f5496">DESCRIPTION</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px">
					  <fo:block><fo:inline color="#2f5496">QUANTITY</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px">
					  <fo:block><fo:inline color="#2f5496">UNIT PRICE</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px">
					  <fo:block><fo:inline color="#2f5496">TOTAL</fo:inline></fo:block>
					</fo:table-cell>
				  </fo:table-row>
				</fo:table-header>
				<fo:table-body>
			  ...
			  <fo:table>
				...
				<fo:table-body>
				  <fo:table-row>
					...
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px">
					  <fo:block font-weight="bold"><fo:inline color="#2f5496">SUBTOTAL</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px">
				  ...
				  <fo:table-row>
					...
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
					  <fo:block font-weight="bold"><fo:inline color="#2f5496">SALES TAX</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
				  ...
				  <fo:table-row>
					...
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
					  <fo:block font-weight="bold"><fo:inline color="#2f5496">SHIPPING &amp; HANDLING</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px" border-bottom="1px solid #eee">
					  <fo:block><xsl:value-of select="SHIPPING"/></fo:block>					
					</fo:table-cell>
				  </fo:table-row>			  
				  <fo:table-row>
					<fo:table-cell>
					...
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px">
					  <fo:block font-weight="bold"><fo:inline color="#2f5496">TOTAL DUE BY DATE</fo:inline></fo:block>
					</fo:table-cell>
					<fo:table-cell text-align="right" padding-bottom="2px" padding-top="2px">
